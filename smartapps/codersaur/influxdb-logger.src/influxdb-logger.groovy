...
private getGroupName(id) {
    ...
    else if (id == 'e147714d-53aa-42b3-9e84-36b46d7b0d0a') {return 'Living room'}
    else if (id == 'e42c3740-7f08-45a5-8baa-64100bfc10cb') {return 'Office bathroom'}
    else if (id == 'e7ec3656-960c-4946-ade3-1136bcbce8cf') {return 'Upstairs bathroom'}
    else if (id == 'f4374d5a-b8e6-4480-bced-781c69a799d0') {return 'Basement'}
    else {return 'Unknown'}    
}